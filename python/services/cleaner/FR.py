...
def clean(covid):
    ...
    df_hosp = pd.read_csv(f"{covid.path_to_save}/{filename_hosp}")
    ...
    df_icu = pd.read_csv(f"{covid.path_to_save}/{filename_icu}")
    ...
    df_test = pd.read_csv(f"{covid.path_to_save}/{filename_tests}")
